 ...
 * Time: 11:22
 */
class Mdg_Megamenu_Block_Page_Html_Topmenu extends Mage_Page_Block_Html_Topmenu {

    public function __construct(){
        parent::__construct();
        $this->setTemplate('mdg/megamenu/megamenu.phtml');
    }
    ...
    public function getMegamenu(){
        ...
        if($effect == 'click'){
            $result .= '<script type="text/javascript" src="http://localhost/magento.vn/js/mdg/megamenu/main_click.js"></script>';
        }
        else {
            $result .= '<script type="text/javascript" src="http://localhost/magento.vn/js/mdg/megamenu/main_hover.js"></script>';
        }
        return $result;
    }
    ...
    public function style(){
        ...
        // Item Style
        $item_style = (Mage::getStoreConfig('megamenu_config/item/item_style') != "normal")
            ? Mage::getStoreConfig('megamenu_config/item/item_style') : "normal";
        // Item Color
