        ...
        switch ($content_type[0]) {
            case 'link':
                switch ($content_type[1]) {
                    case 'text':
                        return 'Anchor Link'; break;
                    case 'page':
                        return 'Page Link'; break;
                    case 'category':
                        return 'Category Link'; break;
                }
                break;
            case 'product':
                switch ($content_type[1])
                {
                    case 'bestseller':
                        return 'Bestseller Product'; break;
                    case 'mostview':
                        return 'Most View Product'; break;
                    case 'select':
                        if ($content_type[2] == 'grid') {
                            return 'Product Selected Grid';
                        } else {
                            return 'Product Selected Listing';
                        }
                        break;
                }
                break;
            case 'category':
                if ($content_type[1] == 'all') {
